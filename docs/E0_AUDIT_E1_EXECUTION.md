...
> **v2 更新：** 本文保留 E0 查验背景和旧协议的研究脉络；当前 E1 schema-v2 的
> 实际服务器命令、Qwen2.5-VL 固定环境、`E1-judge-pilot-v02`、freeze 与恢复流程，
> 统一以 [`E1_A6000_RUNBOOK.md`](E1_A6000_RUNBOOK.md) 为准。不要照本文 v1 命令覆盖旧目录。
